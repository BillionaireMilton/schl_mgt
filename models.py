...
class Teacher(db.Model):
    ...
    teacher_course = Column(String)
    teacher_gender = Column(String)
    date_of_birth = Column(DateTime, default=datetime.utcnow)
    teacher_phone = Column(Integer, default="0000000")
    teacher_type = Column(String, default="full-time")
    teacher_status = Column(String, default="probation")
    teacher_address = Column(String, default="Not Set")
